...
const ProductDetails = () => {
  ...
  const handleBidSubmit = (e) => {
    ...
    if (offeredPrice.length == 0) {
      return Swal.fire({
        position: "top-end",
        icon: "error",
        title: "please place your bid price",
  ...
  useEffect(() => {
    axiosInstance(`/products/bids/${_id}`).then((data) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="w-11/12 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-5">
            <div>
              <img
                src={image}
                className="bg-gray-200 border-2 border-dashed rounded-xl w-full h-96 flex items-center justify-center text-gray-400"
                alt={title}
              />
            </div>
            {/* Product Description */}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <div className="flex items-center gap-4 mb-4">
                <div>
                  <img
                    className="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center text-gray-600 font-bold"
                    src={seller_image}
                    alt={seller_name}
                  />
                </div>
            ...
            <button
              onClick={handleModal}
              className="w-full bg-linear-to-r from-primary
        ...
        {/* bids display  */}
        <div>
          <h2 className="font-bold mt-16 mb-5 text-2xl md:text-5xl">
                      ...
                      <div className="flex items-center gap-3">
                        <div className="avatar">
                          <div className="mask mask-squircle h-12 w-12">
                            <img src={bid?.buyerImageUrl} alt={bid.buyerName} />
                          </div>
                        </div>
                        <div>
